...
// Midtrans
Route::post('paywithmidtrans', 'MidtransPaymentController@payWithMidtrans')->name('paywithmidtrans');
Route::post('midtrans-status', 'MidtransPaymentController@getPaymentStatus')->name('midtrans-status');
Route::post('payment-midtrans/{order_id)', 'MidtransPayController@payment')->name('payment-midtrans');
