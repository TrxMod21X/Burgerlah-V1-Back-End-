                    ...
                    <div class="row">
                        ...
                        @if ($config['status'])
                            <div class="col-md-6 mb-4" style="cursor: pointer">
                                <div class="card" onclick="$('#midtrans-form').submit()">
                                    <div class="card-body pb-0 pt-1" style="height: 70px">
                                        <form class="needs-validation" method="POST" id="midtrans-form"
                                        action="{{ route('paywithmidtrans') }}">
                                        <input type="hidden" value="{{ csrf_token() }}" name="_token" />
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                src="{{ asset('public/assets/admin/img/midtrans.png') }}" />
                                        </button>
                                    </form>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body" style="height: 100px">
                                        <button class="btn btn-block click-if-alone"
                                            ...
                                            <img width="150"
                                                src="{{ asset('public/assets/admin/img/paytabs.png') }}" />
                                        </button>
                                    </div>
                                </div>
                            </div>
