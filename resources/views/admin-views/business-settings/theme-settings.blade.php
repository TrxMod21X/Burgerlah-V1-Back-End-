                ...
                <form action="{{ route('admin.business-settings.theme-settings-update') }}" method="post"
                    ...
                    <div class="form-group" id="user_app_theme">
                        ...
                        <div class="row">
                            ...
                            {{-- New --}}
                            <div class='col-md-3 col-sm-6 col-12 text-center'>
                                <input type="radio" name="theme" require id="img3" class="d-none imgbgchk" value="3" {{ $theme_value == 3 ? 'checked' : '' }}>
                                <label for="img3">
                                    <img class="img-thumbnail rounded"
                                        src="{{ asset('public/assets/admin/img/Theme-2.png') }}" alt="Image 3">
                                </label>
                            </div>
                        </div>
                    </div>
