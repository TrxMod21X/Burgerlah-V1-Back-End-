...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{ __('messages.payment') }} {{ __('messages.gateway') }}
                        {{ __('messages.setup') }}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form action="{{ route('admin.business-settings.payment-method-update', ['digital_payment']) }}"
                            ...
                            @csrf
                            <div class="form-group mb-2">
                                <label class="control-label text-capitalize">{{ __('messages.digital') }}
                                    {{ __('messages.payment') }}</label>
                            </div>
                            <div class="form-group mb-2 mt-2">
                                <input type="radio" class="digital_payment" name="status" value="1"
                                    {{ $digital_payment ? ($digital_payment['status'] == 1 ? 'checked' : '') : '' }}>
                                <label style="padding-left: 10px">{{ __('messages.active') }}</label>
                                <br>
                            </div>
                            <div class="form-group mb-2">
                                <input type="radio" class="digital_payment" name="status" value="0"
        ...
        <div class="row digital_payment_methods" style="padding-bottom: 20px">
            {{-- MIDTRANS METHOD START --}}
            <div class="col-md-6 pt-4">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">{{ __('messages.midtrans') }}</h5>
                        @php($config = \App\CentralLogics\Helpers::get_business_settings('midtrans'))
                        <form
                            action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.payment-method-update', ['midtrans']) : 'javascript:' }}"
                            method="post">
                            @csrf
                            <div class="form-group mb-2">
                                <label class="control-label">{{ __('messages.midtrans') }}</label>
                            </div>
                            <div class="form-group mb-2 mt-2">
                                <input type="radio" name="status" value="1"
                                    {{ $config ? ($config['status'] == 1 ? 'checked' : '') : '' }}>
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{ __('messages.midtrans') }}
                                    {{ __('messages.server') }} {{ __('messages.key') }}</label><br>
                                <input type="text" class="form-control" name="midtrans_server_key"
                                    value="{{ env('APP_MODE') != 'demo' ? ($config ? $config['midtrans_server_key'] : '') : '' }}">
                            </div>
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{ __('messages.midtrans') }}
                                    {{ __('messages.client') }} {{ __('messages.key') }} </label><br>
                                <input type="text" class="form-control" name="midtrans_client_key"
                                    value="{{ env('APP_MODE') != 'demo' ? $config['midtrans_client_key'] ?? '' : '' }}">
                            </div>
                ...
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{ __('messages.paypal') }} {{ __('messages.client') }}
                                    {{ __('messages.id') }}</label><br>
                ...
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @csrf
                            <div class="form-group mb-2">
                                <label class="control-label">{{ __('messages.sslcommerz') }}
                                    {{ __('messages.payment') }}</label>
                            </div>
                            <div class="form-group mb-2 mt-2">
                                <input type="radio" name="status" value="1"
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{ __('messages.store') }} {{ __('messages.id') }}
                                </label><br>
                                <input type="text" class="form-control" name="store_id"
                                    value="{{ env('APP_MODE') != 'demo' ? ($config ? $config['store_id'] : '') : '' }}">
                            </div>
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{ __('messages.store') }}
                                    {{ __('messages.password') }}</label><br>
                ...
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{ __('messages.published') }}
                                    {{ __('messages.key') }}</label><br>
                                <input type="text" class="form-control" name="published_key"
                                    value="{{ env('APP_MODE') != 'demo' ? ($config ? $config['published_key'] : '') : '' }}">
                            </div>

                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{ __('messages.api') }}
                                    {{ __('messages.key') }}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ __('messages.publicKey') }}</label><br>
                                    <input type="text" class="form-control" name="publicKey"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['publicKey'] : '' }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label class="text-capitalize"
                                        style="padding-left: 10px">{{ __('messages.secret') }}
                                        {{ __('messages.key') }} </label><br>
                                ...
                                <div class="form-group mb-2">
                                    <label class="text-capitalize"
                                        style="padding-left: 10px">{{ __('messages.payment') }}
                                        {{ __('messages.url') }}</label><br>
                                    <input type="text" class="form-control" name="paymentUrl"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['paymentUrl'] : '' }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label class="text-capitalize"
                                        style="padding-left: 10px">{{ __('messages.merchant') }}
                                        {{ __('messages.email') }}</label><br>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-info mb-2 pull-right"
                                        onclick="copy_text('{{ url('/') }}/paystack-callback')">{{ __('messages.copy_callback') }}</button>
                                </div>
                            @else
                                <button type="submit"
                ...
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                <div class="form-group mb-2">
                                    <label class="control-label">{{ __('messages.senang') }}
                                        {{ __('messages.pay') }}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1"
                                        {{ $config['status'] == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ __('messages.merchant') }}
                                        {{ __('messages.id') }}</label><br>
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <span class="btn btn-secondary btn-sm m-2"
                                        ...
                                        {{ __('messages.copy_callback') }}</span>
                                    <br>
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ __('messages.integration_id') }}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ __('messages.base_url_by_region') }}</label><br>
